    ...
    <main className="min-h-screen w-full">
      ...
      <section className="w-full px-0 pt-6 sm:pt-24">
        <div className="grid grid-cols-1 gap-y-10">
          <CoverCard title="Teacher Assistant" href="/work" bg={taCover} />
          <CoverCard title="Research Assistant" href="/work#ra" bg={raCover} />
          <CoverCard title="Linxy" href="/work#linxy" bg={linxyCover} />
          <CoverCard title="Peer Mentor" href="/work#pm" bg={pmCover} />
        </div>
      </section>
